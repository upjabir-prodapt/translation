...
from src.worker.doctranslator.utils.common import get_process_pool
...
def parse_pdf(pdf_path, page_ranges=None) -> il_version_1.Document:
    ...
    import src.worker.doctranslator.format.pdf.high_level as pdf_high_level
