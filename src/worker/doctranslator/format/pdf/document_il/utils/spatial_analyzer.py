...
from src.worker.doctranslator.format.pdf.document_il.il_version_1 import PdfCurve
from src.worker.doctranslator.format.pdf.document_il.il_version_1 import PdfForm
