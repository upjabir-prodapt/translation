...
import src.worker.doctranslator.pdfminer.pdfinterp
from src.worker.doctranslator.format.pdf.babelpdf.base14 import get_base14_bbox
from src.worker.doctranslator.format.pdf.babelpdf.cidfont import get_cidfont_bbox
from src.worker.doctranslator.format.pdf.babelpdf.cidfont import get_glyph_bbox
from src.worker.doctranslator.format.pdf.babelpdf.encoding import WinAnsiEncoding
from src.worker.doctranslator.format.pdf.babelpdf.encoding import get_type1_encoding
from src.worker.doctranslator.format.pdf.babelpdf.type3 import get_type3_bbox
...
from src.worker.doctranslator.pdfminer.utils import get_bound
...
class ILCreater:
    ...
    def create_graphic_state(
        self,
        gs: src.worker.doctranslator.pdfminer.pdfinterp.PDFGraphicState
        | list[tuple[str, str]],
    ...
    def on_lt_curve(self, curve: src.worker.doctranslator.pdfminer.layout.LTCurve):
        if not self.enable_graphic_element_process:
            return
        bbox = il_version_1.Box(
            x=curve.bbox[0],
