...
from src.worker.doctranslator.pdfminer.converter import HOCRConverter
from src.worker.doctranslator.pdfminer.converter import HTMLConverter
from src.worker.doctranslator.pdfminer.converter import PDFPageAggregator
from src.worker.doctranslator.pdfminer.converter import TextConverter
from src.worker.doctranslator.pdfminer.converter import XMLConverter
...
from src.worker.doctranslator.pdfminer.pdfdevice import TagExtractor
...
from src.worker.doctranslator.pdfminer.utils import FileOrName
from src.worker.doctranslator.pdfminer.utils import open_filename
...
def extract_text_to_fp(  # NOSONAR - pdfminer-compatible public API intentionally keeps these keyword parameters
    ...
    :param laparams: An LAParams object from src.worker.doctranslator.pdfminer.layout. Default is None
...
def extract_text(
    ...
    :param codec: Text decoding codec
    :param laparams: An LAParams object from src.worker.doctranslator.pdfminer.layout. If None, uses
