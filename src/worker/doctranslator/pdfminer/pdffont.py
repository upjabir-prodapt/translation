...
from src.worker.doctranslator.format.pdf.babelpdf.cmap import CharacterMap
from src.worker.doctranslator.pdfminer import settings
from src.worker.doctranslator.pdfminer.casting import safe_float
from src.worker.doctranslator.pdfminer.casting import safe_rect_list
...
from src.worker.doctranslator.pdfminer.cmapdb import CMapParser
from src.worker.doctranslator.pdfminer.cmapdb import FileUnicodeMap
from src.worker.doctranslator.pdfminer.cmapdb import IdentityUnicodeMap
from src.worker.doctranslator.pdfminer.cmapdb import UnicodeMap
from src.worker.doctranslator.pdfminer.encodingdb import EncodingDB
from src.worker.doctranslator.pdfminer.encodingdb import name2unicode
from src.worker.doctranslator.pdfminer.fontmetrics import FONT_METRICS
...
from src.worker.doctranslator.pdfminer.pdftypes import num_value
from src.worker.doctranslator.pdfminer.pdftypes import resolve1
from src.worker.doctranslator.pdfminer.pdftypes import resolve_all
...
from src.worker.doctranslator.pdfminer.utils import apply_matrix_norm
...
class CFFFont:
    ...
    def _parse_charsets(self) -> None:
        ...
        if charset_format == b"\x00":
            ...
            # Format 2
            raise NotImplementedError(str(("Unhandled", charset_format)))
        else:
