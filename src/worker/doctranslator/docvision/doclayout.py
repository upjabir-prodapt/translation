...
from src.worker.doctranslator.docvision.base_doclayout import DocLayoutModel
from src.worker.doctranslator.docvision.base_doclayout import YoloResult
from src.worker.doctranslator.format.pdf.document_il.utils.mupdf_helper import (
    get_no_rotation_img,
)
...
import src.worker.doctranslator.format.pdf.document_il.il_version_1
...
class OnnxModel(DocLayoutModel):
    ...
    def handle_document(
        self,
        pages: list[src.worker.doctranslator.format.pdf.document_il.il_version_1.Page],
