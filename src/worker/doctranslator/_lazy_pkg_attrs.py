"""PEP 562 helpers for sparse ``__init__.py`` packages under ``src.worker.doctranslator``.

Imports like ``from src.worker.doctranslator.utils import memory`` expect the parent package to expose the
