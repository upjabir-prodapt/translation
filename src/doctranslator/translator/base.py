...
from src.doctranslator.translator.instrumentation import ATTR_LLM_INPUT_TOKENS
from src.doctranslator.translator.instrumentation import ATTR_LLM_LATENCY_S
...
from src.doctranslator.translator.instrumentation import ATTR_LLM_OUTPUT_CHARS
from src.doctranslator.translator.instrumentation import ATTR_LLM_OUTPUT_TOKENS
...
from src.doctranslator.translator.instrumentation import ATTR_LLM_TOTAL_TOKENS
from src.doctranslator.translator.rate_limiter import get_translate_rate_limiter
...
class BaseTranslator(ABC):
    ...
    def translate(self, text, rate_limit_params: dict | None = None):
        ...
        get_translate_rate_limiter().wait(rate_limit_params)
