...
from src.doctranslator.pdfminer.converter import HOCRConverter
from src.doctranslator.pdfminer.converter import HTMLConverter
from src.doctranslator.pdfminer.converter import PDFPageAggregator
from src.doctranslator.pdfminer.converter import TextConverter
from src.doctranslator.pdfminer.converter import XMLConverter
...
from src.doctranslator.pdfminer.pdfdevice import TagExtractor
...
from src.doctranslator.pdfminer.utils import FileOrName
...
def extract_text_to_fp(  # NOSONAR - pdfminer-compatible public API intentionally keeps these keyword parameters
    ...
    :param laparams: An LAParams object from src.doctranslator.pdfminer.layout. Default is None
...
def extract_text(
    ...
    :param codec: Text decoding codec
    :param laparams: An LAParams object from src.doctranslator.pdfminer.layout. If None, uses
