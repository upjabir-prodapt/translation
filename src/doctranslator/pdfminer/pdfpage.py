...
from src.doctranslator.pdfminer.pdfdocument import PDFNoPageLabels
from src.doctranslator.pdfminer.pdfdocument import PDFTextExtractionNotAllowed
...
from src.doctranslator.pdfminer.utils import parse_rect
