...
def add_metadata(
    ...
    for attr in (
        ...
        translated_by = f"DocTranslator{settings.WATERMARK_VERSION}_{time.time()}_Translation_generated_by_AI,please_carefully_discern"
