...
from src.loaders.services.download_service import download_and_verify_async
from src.loaders.services.download_service import download_async
from src.loaders.services.download_service import download_with_retry
...
class TestDownloadService:
    ...
    @patch("src.loaders.services.download_service.download_with_retry")
    @patch(
        "src.loaders.services.download_service.verify_and_raise",
    ...
    @patch(
        "src.loaders.services.download_service.get_cache_file_path",
