...
class TestJobProcessorCore:
    ...
    def test_collect_token_usage(self, processor):
        ...
        from src.api.services.translation_attempt_runner import TranslationAttemptRunner
        from src.doctranslator.translator.providers.gemini import (
    ...
    @patch(
        "src.api.services.model_attempt_orchestrator.ModelAttemptOrchestrator.run_model_chain",
