...
class TestConfidenceService:
    def test_compute_no_retry(self, service):
        res = VerificationResult(
            completeness_score=1.0, omission_score=1.0, hallucination_score=1.0,
            terminology_score=1.0, final_score=0.95, passed=True, reasons=[], judge_model="m1"
        )
    ...
    def test_compute_zero_lower_bound(self, service):
        res = VerificationResult(
            completeness_score=1.0, omission_score=1.0, hallucination_score=1.0,
            terminology_score=1.0, final_score=0.05, passed=False, reasons=[], judge_model="m1"
        )
