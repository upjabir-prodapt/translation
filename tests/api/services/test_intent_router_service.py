...
class TestIntentRouterService:
    ...
    def test_get_model_chain(self, service):
        with patch(
            "src.api.services.intent_router_service.select_model_list"
        ) as mock_select:
    ...
    @patch(
        "src.api.services.intent_router_service.IntentRouterService._load_from_local_fallback"
    )
    @patch(
        "src.api.services.intent_router_service.IntentRouterService._local_cache_fresh",
        return_value=True,
    )
    ...
    @patch(
        "src.api.services.intent_router_service.IntentRouterService.sync_model_selection_cache"
    )
